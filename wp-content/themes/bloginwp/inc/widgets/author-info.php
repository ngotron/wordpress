<?php
/**
 * Adds bloginwp_Author_Info_Widget widget.
 */
class bloginwp_Author_Info_Widget extends WP_Widget {
    /**
     * Register widget with WordPress.
     */
    public function __construct() {
        parent::__construct(
            'bloginwp_author_info_widget',
            esc_html__( 'TSB : Author Info', 'bloginwp' ),
            array( 'description' => __( 'The information of  in detail author.', 'bloginwp' ) )
        );
    }
                ...
                <div class="bmm-author-thumb-wrap">
                    <figure class="bmm-post-thumb">
                        <?php
                            if( $author_image ) {
                            ?>
                                <a href="<?php echo esc_url( $author_url ); ?>" class="card__cover"><img src="<?php echo esc_url( $author_image ); ?>" loading="<?php bloginwp_lazy_load_value(); ?>"></a>
                        <?php } ?> 
                    </figure>
                    <?php
    ...
    function widget_fields() {
        return array(
                array(
                    ...
                    'default'   => esc_html__( 'Author Info', 'bloginwp' )
                ),
                array(
                    'name'      => 'author_name',
                    'type'      => 'text',
                    'title'     => esc_html__( 'Author Name', 'bloginwp' ),
                    'default'   => esc_html__( 'Author Name', 'bloginwp' )
                ),
                array(
                    'name'      => 'author_image',
                    'type'      => 'upload',
                    'title'     => esc_html__( 'Author Image', 'bloginwp' )
                ),
                array(
                    'name'      => 'author_tag',
                    'type'      => 'text',
                    'title'     => esc_html__( 'Author Tag', 'bloginwp' ),
                    'default'   => esc_html__( 'Writer', 'bloginwp' )
                ),
                array(
                    'name'      => 'author_url',
                    'type'      => 'url',
                    'title'     => esc_html__( 'Author URL', 'bloginwp' ),
                ),
                array(
                    'name'      => 'author_desc',
                    'type'      => 'textarea',
                    'title'     => esc_html__( 'Description', 'bloginwp' ),
                    'default'   => esc_html__( 'Lorem ipsum is simply dummy text', 'bloginwp' )
                )
            );
    }
...
} // class bloginwp_Author_Info_Widget