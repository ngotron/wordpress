...
jQuery(document).ready( function($) {
    function bloginwp_widgets_handler() {
        // multicheckbox field
        $( ".bloginwp-multicheckbox-field" ).on( "click, change", ".multicheckbox-content input", function() {
            var _this = $(this), parent = _this.parents( ".bloginwp-multicheckbox-field" ), currentVal, currentFieldVal = parent.find( ".widefat" ).val();
        ...
        // checkbox field
        $( ".bloginwp-checkbox-field" ).on( "click, change", "input", function() {
            var _this = $(this)
            if( _this.is(":checked") ) {
                _this.val( "1" )
            } else {
        ...
        // upload field
        $( ".bloginwp-upload-field" ).on( "click", ".upload-trigger", function(event) {
        ...
        // remove image
        $( ".bloginwp-upload-field" ).on( "click", ".upload-buttons .remove-image", function(event) {
            event.preventDefault();
            var _this = $(this);
