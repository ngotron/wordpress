 ...
 * @since 1.0.0
 */
class Bloginwp_WP_Custom_Repeater extends \WP_Customize_Control {
    /**
     ...
     * Main function
     * 
     * Bloginwp_WP_Custom_Repeater class name 
     */
    ...
    function enqueue() {
        ...
        wp_enqueue_style( 'bloginwp-wp-repeater', get_template_directory_uri() . '/inc/customizer/custom-controls/repeater/repeater.css', array(), BLOGINWP_VERSION, 'all' );
        wp_enqueue_script( 'bloginwp-wp-repeater', get_template_directory_uri() . '/inc/customizer/custom-controls/repeater/repeater.js', array( 'jquery' ), BLOGINWP_VERSION, true );
    }
    ...
    public function render_content() {
        ...
        $item_count = 1;
        ?>
        <div class="bloginwp-repeater-control">
            <label class="customize-control-title"><?php echo esc_html( $this->label ); ?></label>
            <?php if( $this->description ) { ?>
                <span class="description customize-control-description"><?php echo esc_html( $this->description ); ?></span>
            <?php } ?>
            <div class="bloginwp-repeater-control-inner">
                <?php foreach( $control_values as $control_value_key => $control_value ) : ?>
                    <div class="bloginwp-repeater-item <?php if( $control_value->item_option === 'show' ) : echo 'visible'; else : echo 'not-visible'; endif; ?>">
    ...
    function render_control( $field_key, $field, $current_item_value ) {
        $type = $field->type;
        $label = isset( $field->label ) ? $field->label : esc_html__( 'Item Label', 'bloginwp' );
        ...
        switch( $type ) {
            ...
            case 'image' : ?>
                <div class="single-control image-field">
                    ...
                    <div class="image-holder">
                        ...
                        <div class="add-image-trigger <?php if( $current_item_value->$field_key ) echo 'no-trigger'; ?>"><?php echo esc_html__( 'Upload Image', 'bloginwp'); ?></div>
                ...
                <div class="single-control fontawesome-icon-picker">
                    ...
                    <div class="icon-holder">
                        ...
                        <div class="search-field" style="display:none;">
                            <input type="text" placeholder="<?php echo esc_attr__( 'Type to search social icon', 'bloginwp' ); ?>">
                        </div>
            ...
            <?php
            break;
            default: echo esc_html__( 'Not set', 'bloginwp' );
        }   
    }
