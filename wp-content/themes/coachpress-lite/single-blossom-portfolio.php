...
$related_image_size = 'coachpress-lite-blog';
...
while ( have_posts() ) : the_post();
    ...
    $related_title = get_theme_mod( 'related_portfolio_title', __( 'Related Projects', 'coachpress-lite' ) );
