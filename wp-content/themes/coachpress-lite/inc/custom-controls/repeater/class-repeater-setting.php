<?php
/**
 * CoachPress Lite Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'CoachPress_Lite_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class CoachPress_Lite_Repeater_Setting extends WP_Customize_Setting {
