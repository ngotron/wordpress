<?php
/**
 * CoachPress Lite Custom Control
 * 
 * @package CoachPress_Lite
*/

if( ! function_exists( 'coachpress_lite_register_custom_controls' ) ) :
/**
 * Register Custom Controls
*/
function coachpress_lite_register_custom_controls( $wp_customize ){    
    ...
    $wp_customize->register_control_type( 'CoachPress_Lite_Radio_Buttonset_Control' );
    $wp_customize->register_control_type( 'CoachPress_Lite_Radio_Image_Control' );
    $wp_customize->register_control_type( 'CoachPress_Lite_Select_Control' );
    $wp_customize->register_control_type( 'CoachPress_Lite_Slider_Control' );
    $wp_customize->register_control_type( 'CoachPress_Lite_Toggle_Control' );
    $wp_customize->register_control_type( 'CoachPress_Lite_Typography_Control' );
}
endif;
add_action( 'customize_register', 'coachpress_lite_register_custom_controls' );