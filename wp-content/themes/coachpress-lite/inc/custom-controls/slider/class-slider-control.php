<?php
/**
 * CoachPress Lite Customizer Slider Control.
 * 
...
if ( ! class_exists( 'CoachPress_Lite_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class CoachPress_Lite_Slider_Control extends WP_Customize_Control {

		public $type = 'coachpress-lite-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'coachpress-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'coachpress-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
